...
`].filter(fr).join(`
`)),o=ac(o),o=Zh(o,t),o=Jh(o,t),a=ac(a),a=Zh(a,t),a=Jh(a,t),o=Qh(o),a=Qh(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+p);const b=T+m+o,y=T+p+a,D=Yh(s,s.VERTEX_SHADER,b),L=Yh(s,s.FRAGMENT_SHADER,y);s.attachShader(_,D),s.attachShader(_,L),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function R(P){if(n.debug.checkShaderErrors){const Y=s.getProgramInfoLog(_).trim(),k=s.getShaderInfoLog(D).trim(),K=s.getShaderInfoLog(L).trim();let te=!0,W=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(te=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,D,L);else{const Q=$h(s,D,"vertex"),z=$h(s,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
